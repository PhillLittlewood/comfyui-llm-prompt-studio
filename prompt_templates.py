...
TEMPLATES = {
    ...
    "Qwen-Image 2.1 - edit (i2i, reference images)": (
        ...
        "\"the first image\", \"image A\" or \"the left photo\". EXCEPTION: when "
        ...
        "abbreviated. Text you cannot commit to is not added at all. Rendered text "
        "stays monolingual and matches the language the input image already uses, "
        "unless the user names the words or the language. Match the typography the "
        "input establishes. When the canvas is extended outward, call it outpainting "
        "explicitly.\n"
        ...
        "ratio is the latent's job in ComfyUI. Return ONE continuous paragraph with "
        "no line breaks."
    ),
    # ------------------------------------------------------------------ FLUX.2 KLEIN
    "FLUX.2 Klein (9B)": (
